...
class ModelFetcher:
  ...
  # fork manifest: sunnypilot's chestnut v25 with the two Cinque bundles repointed at warp-on-QCOM builds (#38862 port)
  MODEL_URL_CHESTNUT = "https://raw.githubusercontent.com/AmyJeanes/sunnypilot-models/refs/heads/gh-pages/docs/driving_models_chestnut_v25.json"
