...
class LongitudinalPlanner(LongitudinalPlannerSP):
  ...
  def update(self, sm):
    ...
    v_cruise_kph = min(sm['carState'].vCruiseCluster, V_CRUISE_MAX)
    ...
    v_cruise, self.a_desired, _ = LongitudinalPlannerSP.update_targets(self, sm, self.v_desired_filter.x, self.a_desired, v_cruise)
